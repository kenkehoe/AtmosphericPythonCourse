...
# Block 1
if True:
    # Create some data. data1 is int type and data2 is float type just to show
...
# Block 3
# Lest start changing the values to meet our needs. Need to change first block to True
# for us to use that data. 
if False:
